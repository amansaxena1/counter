...
async function dataload() {
  await fetch("https://codecoffee-eight.vercel.app/aman_saxena_01/amansaxena1/amansaxena01/amansaxena1/amansaxena1/amansaxena1/7f701168-4427-434e-9f2c-98c4bf09cb3b")
    .then((res) => res.json())
    .then((data) => {
